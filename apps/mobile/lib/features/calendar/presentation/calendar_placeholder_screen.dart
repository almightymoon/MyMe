...
class CalendarPlaceholderScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final eventDays = cal.eventDaysInVisibleMonth();
    final cells = _buildCells(cal.visibleMonth);
    final agenda = cal.selectedEvents;
