...
| `/profile` | ProfileScreen | Yes | All | Local prefs | displayName + prefs | OnboardingPreferences | Yes | Defaults | Yes | Yes | Local | — | Edit / shortcuts | Prefs | Yes | Today greeting | Back | Labels | — | Yes | — | Complete | — |
